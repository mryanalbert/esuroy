...
if (isset($_POST['action'])) {
  ...
  if ($_POST['action'] == 'fetchSpotsBasedOnCities') {
    $cityCode = $query->testInput($_POST['cityCode']);
    echo json_encode($query->fetchSpotsBasedOnCities($cityCode));
  }
  
  // Fetch Spot
  if ($_POST['action'] == 'fetchSpot') {
    $spotId = $query->testInput($_POST['id']);
  ...
  if ($_POST['action'] == 'fetchHotelsBasedOnCities') {
    $cityCode = $query->testInput($_POST['cityCode']);
    echo json_encode($query->fetchHotelsBasedOnCities($cityCode));
  }

  // Fetch Hotel
  if ($_POST['action'] == 'fetchHotel') {
    $hotelId = $query->testInput($_POST['id']);
  ...
  if ($_POST['action'] == 'fetchEventsBasedOnCities') {
    $cityCode = $query->testInput($_POST['cityCode']);
    echo json_encode($query->fetchEventsBasedOnCities($cityCode));
  }

  // Fetch Event
  if ($_POST['action'] == 'fetchEvent') {
    $eventId = $query->testInput($_POST['id']);
