...
class Query extends Database
{
  ...
  public function fetchSpotsBasedOnCities($cityCode) {
    $sql = "SELECT spot_id, spot_name, brgy_desc FROM barangays
            INNER JOIN spots
  ...
  public function fetchHotelsBasedOnCities($cityCode) {
    $sql = "SELECT hotel_id, hotel_name, hotel_offers_meal, brgy_desc FROM barangays
            INNER JOIN hotels
  ...
  public function fetchEventsBasedOnCities($cityCode) {
    $sql = "SELECT * FROM barangays
            INNER JOIN events
