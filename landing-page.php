      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item px-3">
              <a class="nav-link active fs-5" aria-current="page" href="hotels.php">Hotels</a>
            </li>
            <li class="nav-item px-3">
  ...
  <div id="carouselExampleCaptions" class="carousel slide">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="./img/dako black2.jpg" style="object-fit:cover;height:100vh;" class="d-block w-100" alt="...">
      ...
      <div class="carousel-item">
        <img src="./img/mountain view black2.jpg" style="object-fit:cover;height:100vh;" class="d-block w-100" alt="...">
        <div class="carousel-caption h-100 d-flex justify-content-center align-items-center">
          <div style="transform: translate(0px, 60px);">
      ...
      <div class="carousel-item">
        <img src="img/surf black2.jpg" style="object-fit:cover;height:100vh;" class="d-block w-100" alt="...">
        <div class="carousel-caption h-100 d-flex justify-content-center align-items-center">
          <div style="transform: translate(0px, 60px);">
